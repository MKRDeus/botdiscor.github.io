...
let getNewTech = async () => {
    let response = await axios.get('https://newsapi.org/v2/top-headlines?country=co&category=health&apiKey=ff414b1553754449869ac91920b4fa60');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('health-co')
        .setDescription('Provides information about Health News from Colombia '),
