...
let getNewTech = async () => {
    let response = await axios.get('https://newsapi.org/v2/top-headlines?country=ie&category=sports&apiKey=ff414b1553754449869ac91920b4fa60');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('sports-ie')
        .setDescription('Provides information about sports News from Irlanda '),
