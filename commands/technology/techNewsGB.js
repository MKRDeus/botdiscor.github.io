...
let getNewTech = async () => {
    let response = await axios.get('https://newsapi.org/v2/top-headlines?country=gb&category=technology&apiKey=ff414b1553754449869ac91920b4fa60');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('tech-gb')
        .setDescription('Provides information about technology News from united kingdom '),
    async execute(interaction) {
        ...
        console.log(news.articles[randomNew[0]].url);
    },
};
