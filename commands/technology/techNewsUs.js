...
let getNewTech = async () => {
    let response = await axios.get('https://newsapi.org/v2/top-headlines?country=us&category=technology&apiKey=ff414b1553754449869ac91920b4fa60');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('tech-us')
        .setDescription('Provides information about technology News from USA '),
    async execute(interaction) {
        ...
        .setImage(`${news.articles[randomNew[0]].urlToImage}`)
        .setFooter({ text: `${date}` });
