...
let getNewTech = async () => {
    let response = await axios.get('https://newsapi.org/v2/top-headlines?country=pt&category=business&apiKey=ff414b1553754449869ac91920b4fa60');
...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('business-pt')
        .setDescription('Provides information about Business News from Portugal '),
